...
export const metadata: Metadata = {
  title: "24 Hour Towing & Auto Help Edmond OKC | Paul's Automotive",  description: "Fast emergency towing, recovery, and auto repair in Edmond and OKC. Paul's Automotive: 24/7 service, fair pricing, honest work. Call (405) 285-2238.",  keywords: "towing Edmond, emergency towing OKC, auto repair, roadside assistance, 24 hour tow truck",  metadataBase: new URL("https://paulsautomotive.com"),
  alternates: {
    canonical: "https://paulsautomotive.com"},
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "24 Hour Towing & Trustworthy Auto Help",    description: "Paul's Automotive: Emergency towing, recovery, and repair. Fast arrival. Fair pricing. Edmond & OKC metro.",    url: "https://paulsautomotive.com",    siteName: "Paul's Automotive",    type: "website",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/emergency-auto-mechanic-changing-flat-tire-road_651396-3559.jpg",        alt: "Paul's Automotive 24-hour emergency towing"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "24 Hour Towing in Edmond & OKC",    description: "Paul's Automotive: Fast, trusted emergency towing and auto repair. Call (405) 285-2238.",    images: ["http://img.b2bpic.net/free-photo/emergency-auto-mechanic-changing-flat-tire-road_651396-3559.jpg"],
  },
};
